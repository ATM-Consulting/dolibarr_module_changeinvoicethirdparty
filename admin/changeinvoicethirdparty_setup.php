...
/**
 * 	\file		admin/changeinvoicethirdparty.php
...
require_once '../lib/changeinvoicethirdparty.lib.php';
 ...
 * View
 */
$page_name = "changeinvoicethirdpartySetup";
...
$head = changeinvoicethirdpartyAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104871Name"),
    0,
    "changeinvoicethirdparty@changeinvoicethirdparty"
);
/*
