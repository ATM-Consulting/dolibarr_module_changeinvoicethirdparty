...
/**
 * 	\defgroup   changeinvoicethirdparty     Module changeinvoicethirdparty
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/changeinvoicethirdparty/core/modules directory.
 *  \file       htdocs/changeinvoicethirdparty/core/modules/modchangeinvoicethirdparty.class.php
 *  \ingroup    changeinvoicethirdparty
 *  \brief      Description and activation file for module changeinvoicethirdparty
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module changeinvoicethirdparty
 */
class modchangeinvoicethirdparty extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->numero = 104871; // 104000 to 104999 for ATM CONSULTING
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'changeinvoicethirdparty';
		...
		// for default path (eg: /changeinvoicethirdparty/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /changeinvoicethirdparty/core/modules/barcode)
		// for specific css file (eg: /changeinvoicethirdparty/css/changeinvoicethirdparty.css.php)
		...
		//							'css' => array('/changeinvoicethirdparty/css/changeinvoicethirdparty.css.php'),	// Set this to relative path of css file if module has its own css file
		...
		$this->langfiles = array("changeinvoicethirdparty@changeinvoicethirdparty");
...
*/
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=changeinvoicethirdparty',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'changeinvoicethirdparty top menu',
		//							'mainmenu'=>'changeinvoicethirdparty',
		//							'leftmenu'=>'changeinvoicethirdparty_left',			// This is the name of left menu for the next entries
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=changeinvoicethirdparty,fk_leftmenu=changeinvoicethirdparty_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'changeinvoicethirdparty left menu',
		//							'mainmenu'=>'changeinvoicethirdparty',
		//							'leftmenu'=>'changeinvoicethirdparty_left',			// Goes into left menu previously created by the mainmenu
...
/*
		$this->menu[$r]=array(
			...
			'type'=>'top',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuchangeinvoicethirdparty'),
			'mainmenu'=>'changeinvoicethirdparty',
			'leftmenu'=>'',
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=changeinvoicethirdparty',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuchangeinvoicethirdparty'),
			'mainmenu'=>'changeinvoicethirdparty',
			'leftmenu'=>'changeinvoicethirdparty_left',
			'url'=>'/changeinvoicethirdparty/list.php',
			'langs'=>'changeinvoicethirdparty@changeinvoicethirdparty',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->changeinvoicethirdparty->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=changeinvoicethirdparty,fk_leftmenu=changeinvoicethirdparty_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuchangeinvoicethirdpartyCreate'),
			'mainmenu'=>'changeinvoicethirdparty',
			'leftmenu'=>'changeinvoicethirdparty_left_create',
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=changeinvoicethirdparty,fk_leftmenu=changeinvoicethirdparty_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuchangeinvoicethirdpartyList'),
			'mainmenu'=>'changeinvoicethirdparty',
			'leftmenu'=>'changeinvoicethirdparty_left_list',
			'url'=>'/changeinvoicethirdparty/list.php',
			'langs'=>'changeinvoicethirdparty@changeinvoicethirdparty',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->changeinvoicethirdparty->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
...
*/
	...
	function init($options='')
	{
		...
		dol_include_once('/changeinvoicethirdparty/config.php');
		dol_include_once('/changeinvoicethirdparty/script/create-maj-base.php');

		$result=$this->_load_tables('/changeinvoicethirdparty/sql/');
